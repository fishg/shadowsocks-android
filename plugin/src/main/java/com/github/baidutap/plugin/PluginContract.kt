...
object PluginContract {
     ...
     *
     * Constant Value: "com.github.baidutap.plugin.ACTION_NATIVE_PLUGIN"
     */
    const val ACTION_NATIVE_PLUGIN = "com.github.baidutap.plugin.ACTION_NATIVE_PLUGIN"

    /**
     * Activity Action: Used for ConfigurationActivity.
     *
     * Constant Value: "com.github.baidutap.plugin.ACTION_CONFIGURE"
     */
    const val ACTION_CONFIGURE = "com.github.baidutap.plugin.ACTION_CONFIGURE"
    /**
     * Activity Action: Used for HelpActivity or HelpCallback.
     *
     * Constant Value: "com.github.baidutap.plugin.ACTION_HELP"
     */
    const val ACTION_HELP = "com.github.baidutap.plugin.ACTION_HELP"

    /**
     * The lookup key for a string that provides the plugin entry binary.
     *
     * Example: "/data/data/com.github.baidutap.plugin.obfs_local/lib/libobfs-local.so"
     *
     * Constant Value: "com.github.baidutap.plugin.EXTRA_ENTRY"
     */
    const val EXTRA_ENTRY = "com.github.baidutap.plugin.EXTRA_ENTRY"
    /**
     * The lookup key for a string that provides the options as a string.
     *
     * Example: "obfs=http;obfs-host=www.baidu.com"
     *
     * Constant Value: "com.github.baidutap.plugin.EXTRA_OPTIONS"
     */
    const val EXTRA_OPTIONS = "com.github.baidutap.plugin.EXTRA_OPTIONS"
    /**
     ...
     *
     * Constant Value: "com.github.baidutap.plugin.EXTRA_HELP_MESSAGE"
    </host_name> */
    const val EXTRA_HELP_MESSAGE = "com.github.baidutap.plugin.EXTRA_HELP_MESSAGE"

    /**
     * The metadata key to retrieve plugin id. Required for plugins.
     *
     * Constant Value: "com.github.baidutap.plugin.id"
     */
    const val METADATA_KEY_ID = "com.github.baidutap.plugin.id"
    /**
     ...
     *
     * Constant Value: "com.github.baidutap.plugin.id.aliases"
     */
    const val METADATA_KEY_ID_ALIASES = "com.github.baidutap.plugin.id.aliases"
    /**
     * The metadata key to retrieve default configuration. Default value is empty.
     *
     * Constant Value: "com.github.baidutap.plugin.default_config"
     */
    const val METADATA_KEY_DEFAULT_CONFIG = "com.github.baidutap.plugin.default_config"
    /**
     ...
     *
     * Constant Value: "com.github.baidutap.plugin.executable_path"
     */
    const val METADATA_KEY_EXECUTABLE_PATH = "com.github.baidutap.plugin.executable_path"
     ...
     */
    const val AUTHORITY = "com.github.baidutap"
}
