* 1.3.4:
  * Optional new metadata `com.github.baidutap.plugin.id.aliases` for plugin ID aliases;
...
* 1.3.0:
  * Optional new metadata `com.github.baidutap.plugin.executable_path` for even faster initialization;
